...
MIN_WP_DIST = 150.0    # metres  (road-distance between consecutive anchors)
MAX_WP_DIST = 200.0
NUM_ANCHORS = 1       # intermediate waypoints (plus ego start = 5 stops total)
...
def pick_anchor_waypoints(start_wp: carla.Waypoint,
    ...
    anchors  = []
    current  = start_wp
    STEP     = 2.0   # metres per graph step
